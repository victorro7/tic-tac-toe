...
def max_value(board):
    ...
    for move in moves(board):
        v = min(v, min_value(result(board, move)))
    return v
...
def minimax(board):
    ...
    # Case of player is X
        ...
        for move in moves(board):
            # Add in plays a tupple with the min_value and the moves that results to its value
    ...
    # Case of player is O
        ...
        plays = []
        for move in moves(board):
            # Add in plays a tupple with the max_value and the moves that results to its value
